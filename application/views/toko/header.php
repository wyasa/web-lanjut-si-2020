...
<body >
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-primary border-right " id="sidebar-wrapper">
      ...
      <div class="bg-danger sidebar-heading "> <font color='white'>
       ...
       TOKO MAKMUR</font> </div>
      <div class="list-group list-group-flush bg-primary">
       <a href    = "<?= site_url('AController/index') ?>" class="list-group-item list-group-item-action bg-primary">
                  <font color='white'>
        ...
        <a href="<?= site_url('i_controller/index') ?>" class="list-group-item list-group-item-action bg-primary">
                       <font color='white'>
        ...
        <a href=" <?= site_url('o_controller/index') ?> " class="list-group-item list-group-item-action bg-primary"">
               <font color='white'> 
        ...
        <a href=" <?= site_url('user/index') ?> "class="list-group-item list-group-item-action bg-primary">
              <font color='white'>
                ...
                USERS</font></a>
        <a href= " <?= site_url('login/logout') ?> " class="list-group-item list-group-item-action bg-primary">
              <font color='white'>
